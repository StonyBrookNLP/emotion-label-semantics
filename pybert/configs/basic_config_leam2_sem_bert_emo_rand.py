...
checkpoints_name = "checkpoints_leam2_sem_bert_emo_rand"
config = {
    ...
    'bert_vocab_path': BASE_DIR / '/home/rgaonkar/context_home/rgaonkar/label_embeddings/code/Bert_Masked_LM/output/random_emotion/model_checkpoint/vocab.txt',
